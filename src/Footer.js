...
function Footer() {
  ...
  <div className="container pt-9">
    ...
    <form action="">
      <div className=" sm:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
        ...
        <div className="md:mr-auto mb-6">
          <button type="button" className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Contact</button>
        </div>
      </div>
    </form>
  </div>
  ...
  <div className="text-center text-gray-700 p-4 bg-[rgba(0, 0, 0, 0.2)]">
    © 2021 Copyright:
    <a className="text-gray-800" href="https://tailwind-elements.com/">Health Care</a>
  </div>
</footer>
    </div>
  )
